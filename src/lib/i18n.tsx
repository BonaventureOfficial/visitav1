...
const dict = {
  en: {
    ...
    all: "All", home: "Home", upload: "New", profile: "Profile", reels: "Reels",
    chooseType: "What are you publishing?", longVideo: "Long video", longVideoHint: "No limit — shows, podcasts, docs",
    reel: "Reel", reelHint: "Short vertical clip · max 2 min",
    reelTooLong: "Reels must be 2 minutes or less",
  ...
  fr: {
    ...
    all: "Tous", home: "Accueil", upload: "Nouveau", profile: "Profil", reels: "Reels",
    chooseType: "Que voulez-vous publier ?", longVideo: "Vidéo longue", longVideoHint: "Sans limite — émissions, podcasts, docs",
    reel: "Reel", reelHint: "Clip vertical court · max 2 min",
    reelTooLong: "Les reels doivent durer 2 minutes maximum",
