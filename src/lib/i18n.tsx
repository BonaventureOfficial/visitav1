...
const dict = {
  en: {
    ...
    noVideosYet: "No videos yet. Be the first to publish.",
    uploadFirst: "Upload the first video",
    videoFile: "Video file",
    dropVideo: "Tap to select a video",
    dropVideoHint: "HD quality preserved · MP4, MOV, WEBM",
    titlePlaceholder: "Give your video a title",
    chooseThumb: "Choose a thumbnail",
    uploadCustomThumb: "Upload from device",
  ...
  fr: {
    ...
    noVideosYet: "Aucune vidéo pour l'instant. Soyez le premier à publier.",
    uploadFirst: "Publier la première vidéo",
    videoFile: "Fichier vidéo",
    dropVideo: "Touchez pour sélectionner une vidéo",
    dropVideoHint: "Qualité HD préservée · MP4, MOV, WEBM",
    titlePlaceholder: "Donnez un titre à votre vidéo",
    chooseThumb: "Choisissez une miniature",
    uploadCustomThumb: "Importer depuis l'appareil",
